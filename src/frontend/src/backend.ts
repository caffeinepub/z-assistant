...
export class Backend implements backendInterface {
    ...
    async addUserMessage(arg0: string): Promise<Message> {
        if (this.processError) {
            try {
                const result = await this.actor.addUserMessage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAssistantName(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getAssistantName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAssistantName(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAssistantName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
